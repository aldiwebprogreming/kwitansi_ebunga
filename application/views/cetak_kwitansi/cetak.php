...
table tr:nth-child(even) {
    background:#F0F8FF;
		...
		<p style="position: absolute; top: 67px; left: 298px;">63/10/III/2021</p>

		<p id="terima" style="position: absolute; top: 107px; left: 396px; font-weight: bold; font-family:courier">Alumni Setia Budi SD'86 - SMP'89</p>

		<div class="terbilang" style="position: absolute; top: 100px; left: 400px; width: 450px; font-style: italic;">
		<p id="terbilang" style=" font-family:courier; margin-top: 15px; line-height: 1.8">Seratus Sembilan Puluh Empat Ribu Sembilan Ratus Rupiah.</p>
		</div>

		<div class="untuk_pembayaran" style="position: absolute; top: 147px; left: 270px; width: 580px;">
		<p id="terbilang" style=" font-family:courier; margin-top: 15px; line-height: 1.5; text-indent: 130px;">Seratus Sembilan Puluh Empat Ribu Sembilan Ratus Rupiah. Seratus Sembilan Puluh Empat Ribu Sembilan Ratus Rupiah.</p>
		</div>

		<p class="harga" style="position: absolute; top: 244px; left: 643px; font-family: courier; font-weight: bold;">Medan, <?= date('d-m-Y') ?></p>

		<p class="harga" style="position: absolute; top: 280px; left: 380px; font-family: courier; font-weight: bold;">194.400,-</p>
